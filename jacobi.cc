...
namespace mhd
{
  ...
  void MHDequations<dim>::JacobiM(double v[])
  {
    ...
    case 3:
    //A[2][0][0] = 0;  // density
    //A[2][0][1] = 0;  // Pix, Piy, Piz
    //A[2][0][2] = 0;
    A[2][0][3] = 1;
    //A[2][0][4] = 0;  // Bx, By, Bz
    //A[2][0][5] = 0;
    //A[2][0][6] = 0;
    //A[2][0][7] = 0;  // total energy U
    //A[2][0][8] = 0;  // Jx, Jy Jz
    //A[2][0][9] = 0;
    //A[2][0][10] = 0;
    //A[2][0][11] = 0; // reistivity
    ...
    A[2][7][9] = -2 * v[11]*v[4];
    //A[2][7][10] = 0;
    A[2][7][11] = 0.0;//2.0*(v[5]*v[8]-v[4]*v[9]);
    ...
    //A[1][7][9] = 0;
    A[1][7][10] = 2 * v[11]*v[4];
    A[1][7][11] = 0;//2.0*(v[4]*v[10]-v[6]*v[8]);
    ...
    A[0][7][9] = 2 * v[11]*v[6];
    A[0][7][10] = -2 * v[11]*v[5];
    A[0][7][11] = 0;//2.0*(v[6]*v[9]-v[5]*v[10]);
...
//     B[6][10]=0;
    ...
    B[7][5]=(2*(-v[0]*(v[2]*dv[0][4]+(-2+GAMMA)*v[1]*dv[0][5]+v[11]*v[0]*dv[0][10])+(-2+GAMMA)*v[5]*(dv[0][0]*v[1]-v[0]*dv[0][1])+v[4]*(dv[0][0]*v[2]-v[0]*dv[0][2])))*iRh2;
    B[7][6]=(2*(v[0]*(-v[3]*dv[0][4]-(-2+GAMMA)*v[1]*dv[0][6]+v[11]*v[0]*dv[0][9])+(-2+GAMMA)*v[6]*(dv[0][0]*v[1]-v[0]*dv[0][1])+v[4]*(dv[0][0]*v[3]-v[0]*dv[0][3])))*iRh2;
    B[7][7]=(-dv[0][0]*GAMMA*v[1]+GAMMA*v[0]*dv[0][1])*iRh2;
//     B[7][8]=0;
    B[7][9]=2*(v[11]*dv[0][6]);//+v[6]*dv[0][11]);
    B[7][10]=-2*(v[11]*dv[0][5]);//+v[5]*dv[0][11]);
    B[7][11]=0;//2.0*(v[9]*dv[0][6]+v[6]*dv[0][9]-v[10]*dv[0][5]-v[5]*dv[0][10]);
...
//    B[6][10]=0;
    ...
    B[7][4]=(1/(v[0]*v[0]))*2*(dv[0][0]*v[6]*v[3]-v[0]*(GAMMA*v[1]*dv[0][4]+v[2]*dv[0][5])-v[0]*v[3]*dv[0][6]-v[0]*v[6]*dv[0][3]+2*v[0]*v[2]*dv[1][4]-GAMMA*v[0]*v[2]*dv[1][4]-v[0]*v[1]*dv[1][5]+v[11]*v[0]*v[0]*dv[1][10]+v[5]*(dv[1][0]*v[1]+dv[0][0]*v[2]-v[0]*(dv[0][2]+dv[1][1]))+v[4]*(dv[0][0]*GAMMA*v[1]+dv[1][0]*(-2+GAMMA)*v[2]-GAMMA*v[0]*dv[0][1]-(-2+GAMMA)*v[0]*dv[1][2]));
    B[7][5]=-(1/(v[0]*v[0]))*2*(-dv[1][0]*v[6]*v[3]+v[0]*(v[11]*v[0]*dv[0][10]+v[1]*((-2+GAMMA)*dv[0][5]+dv[1][4])+v[2]*(dv[0][4]+GAMMA*dv[1][5]))+v[0]*v[3]*dv[1][6]+v[4]*(-dv[1][0]*v[1]-dv[0][0]*v[2]+v[0]*(dv[0][2]+dv[1][1]))+v[5]*(-dv[0][0]*(-2+GAMMA)*v[1]-dv[1][0]*GAMMA*v[2]+(-2+GAMMA)*v[0]*dv[0][1]+GAMMA*v[0]*dv[1][2])+v[0]*v[6]*dv[1][3]);
    B[7][6]=(1/(v[0]*v[0]))*2*(dv[1][0]*v[5]*v[3]-v[0]*v[3]*dv[0][4]+2*v[0]*v[1]*dv[0][6]-GAMMA*v[0]*v[1]*dv[0][6]+v[11]*v[0]*v[0]*dv[0][9]+v[4]*(dv[0][0]*v[3]-v[0]*dv[0][3])-v[0]*v[3]*dv[1][5]+2*v[0]*v[2]*dv[1][6]-GAMMA*v[0]*v[2]*dv[1][6]-v[11]*v[0]*v[0]*dv[1][8]+(-2+GAMMA)*v[6]*(dv[0][0]*v[1]+dv[1][0]*v[2]-v[0]*(dv[0][1]+dv[1][2]))-v[0]*v[5]*dv[1][3]);
    B[7][7]=(GAMMA*(-dv[0][0]*v[1]-dv[1][0]*v[2]+v[0]*(dv[0][1]+dv[1][2])))*iRh2;
    B[7][8]=-2*(v[11]*dv[1][6]);//+v[6]*dv[1][11]);
    B[7][9]=2*(v[11]*dv[0][6]);//+v[6]*dv[0][11]);
    B[7][10]=2*(v[11]*(-dv[0][5]+dv[1][4]));//-v[5]*dv[0][11]+v[4]*dv[1][11]);
    B[7][11]=0;//2.0*(v[9]*dv[0][6]-v[5]*dv[0][10]+v[10]*(dv[1][4]-dv[0][5])-v[8]*dv[1][6]+v[6]*(dv[0][9]-dv[1][8])+v[4]*dv[1][10]);
...
//     B[6][10]=0;
    ...
    B[7][4]=iRh2*2*(dv[2][0]*v[6]*v[1]+dv[0][0]*v[6]*v[3]-GAMMA*v[0]*v[1]*dv[0][4]-v[0]*v[2]*dv[0][5]-v[0]*v[3]*dv[0][6]-v[0]*v[6]*dv[0][3]+2*v[0]*v[2]*dv[1][4]-GAMMA*v[0]*v[2]*dv[1][4]-v[0]*v[1]*dv[1][5]+v[11]*v[0]*v[0]*dv[1][10]+v[5]*(dv[1][0]*v[1]+dv[0][0]*v[2]-v[0]*(dv[0][2]+dv[1][1]))+2*v[0]*v[3]*dv[2][4]-GAMMA*v[0]*v[3]*dv[2][4]-v[0]*v[1]*dv[2][6]-v[11]*v[0]*v[0]*dv[2][9]-v[0]*v[6]*dv[2][1]+v[4]*(dv[0][0]*GAMMA*v[1]+(-2+GAMMA)*(dv[1][0]*v[2]+dv[2][0]*v[3])-v[0]*(GAMMA*dv[0][1]+(-2+GAMMA)*(dv[1][2]+dv[2][3]))));
    B[7][5]=-iRh2*2*(-dv[2][0]*v[6]*v[2]-dv[1][0]*v[6]*v[3]+v[0]*v[2]*dv[0][4]-2*v[0]*v[1]*dv[0][5]+GAMMA*v[0]*v[1]*dv[0][5]+v[11]*v[0]*v[0]*dv[0][10]+v[0]*v[1]*dv[1][4]+GAMMA*v[0]*v[2]*dv[1][5]+v[0]*v[3]*dv[1][6]+v[4]*(-dv[1][0]*v[1]-dv[0][0]*v[2]+v[0]*(dv[0][2]+dv[1][1]))+v[0]*v[6]*dv[1][3]-2*v[0]*v[3]*dv[2][5]+GAMMA*v[0]*v[3]*dv[2][5]+v[0]*v[2]*dv[2][6]-v[11]*v[0]*v[0]*dv[2][8]+v[0]*v[6]*dv[2][2]+v[5]*(-dv[0][0]*(-2+GAMMA)*v[1]-dv[1][0]*GAMMA*v[2]-dv[2][0]*(-2+GAMMA)*v[3]+v[0]*((-2+GAMMA)*dv[0][1]+GAMMA*dv[1][2]+(-2+GAMMA)*dv[2][3])));
    B[7][6]=iRh2*2*(dv[2][0]*v[5]*v[2]+dv[1][0]*v[5]*v[3]-v[0]*v[3]*dv[0][4]+2*v[0]*v[1]*dv[0][6]-GAMMA*v[0]*v[1]*dv[0][6]+v[11]*v[0]*v[0]*dv[0][9]-v[0]*v[3]*dv[1][5]+2*v[0]*v[2]*dv[1][6]-GAMMA*v[0]*v[2]*dv[1][6]-v[11]*v[0]*v[0]*dv[1][8]-v[0]*v[5]*dv[1][3]-v[0]*v[1]*dv[2][4]-v[0]*v[2]*dv[2][5]-GAMMA*v[0]*v[3]*dv[2][6]+v[4]*(dv[2][0]*v[1]+dv[0][0]*v[3]-v[0]*(dv[0][3]+dv[2][1]))-v[0]*v[5]*dv[2][2]+v[6]*((-2+GAMMA)*(dv[0][0]*v[1]+dv[1][0]*v[2])+dv[2][0]*GAMMA*v[3]-(-2+GAMMA)*v[0]*(dv[0][1]+dv[1][2])-GAMMA*v[0]*dv[2][3]));
    B[7][7]=(GAMMA*(-dv[0][0]*v[1]-dv[1][0]*v[2]-dv[2][0]*v[3]+v[0]*(dv[0][1]+dv[1][2]+dv[2][3])))*iRh2;
    B[7][8]=2*(v[11]*(dv[2][5]-dv[1][6]));// +v[5]*dv[2][11]-v[6]*dv[1][11]);
    B[7][9]=2*(v[11]*(dv[0][6]-dv[2][4]));// +v[6]*dv[0][11]-v[4]*dv[2][11]);
    B[7][10]=2*(v[11]*(dv[1][4]-dv[0][5]));// +v[4]*dv[1][11]-v[5]*dv[0][11]);
    B[7][11]=0;//2*(v[10]*(dv[1][4]-dv[0][5])+v[6]*(dv[0][9]-dv[1][8])+v[9]*(dv[0][6]-dv[2][4])+v[8]*(dv[2][5]-dv[1][6])+v[5]*(dv[2][8]-dv[0][10])+v[4]*(dv[1][10]-dv[2][9]));
